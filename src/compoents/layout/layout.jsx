            ...
            <nav className='flex justify-between items-center px-5 py-5  '>
                ...
                <div className='hidden xl:flex mr-40 '>
                    <ul className='flex flex-grow gap-10 items-center 2 text-white '>
                        ...
                        <li className='px-2 py-2 '><Link className=" capitalize xl:text-2xl " to={'/'}>about</Link></li>
                        <li className='px-2 py-2 '><Link className=" capitalize xl:text-2xl " to={'/'}>shop</Link></li>
                        <li className='px-2 py-2 '><Link className=" capitalize xl:text-2xl " to={'/'}>contact</Link></li>

                    </ul>
                <button className={`p-1 ml-10 bg-slate-200 py-1 px-1 rounded-xl`}><img className='w-8 h-auto ' src="https://cdn-icons-png.flaticon.com/128/2838/2838895.png" alt="" /></button>
